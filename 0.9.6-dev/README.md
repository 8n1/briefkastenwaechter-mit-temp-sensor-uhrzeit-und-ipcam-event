...
## Ablauf/Features:
* Verbindet sich nach dem anlegen der Batteriespannung oder einem Reset automatisch mit dem gespeicherten WLAN Netzwerk
...
-> Zeitkonstante für den Timer Alarm mit dem geprüft wird ob der ESP eine IP bekommen hat
* **timout = 10**
